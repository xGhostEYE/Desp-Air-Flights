...
def check_departure_flights(departure_df, gdb):
    ...
    flightNums = departure_df["FlightNum"].unique().tolist()
    for flightNum in flightNums:
        ...
        if departureCode != departureCode_result:
            print("update_airport_departures function failed for flight", flightNum, ", departure codes did not match: ")
        ...
        if departureCode != departureCode_result:
            print("update_airport_departures function failed for flight", flightNum, ", departure times did not match: ")
        ...
        if departureCode != departureCode_result:
            print("update_airport_departures function failed for flight", flightNum, ", flight status did not match: ")
            print("\nInput:", status, "\nOutput:", status_result)
        
        # check Carrier
        carrier = departure_df["Carrier"].values[0]
        carrier_result = results_df["Carriers"].values[0]
        if departureCode != departureCode_result:
            print("update_airport_departures function failed for flight", flightNum, ", flight carrier did not match: ")
        ...
        if departureCode != departureCode_result:
            print("update_airport_departures function failed for flight", flightNum, ", flight number did not match: ")
        ...
        if departureCode != departureCode_result:
            print("update_airport_departures function failed for flight", flightNum, ", flight gate did not match: ")
            print("\nInput:", gate, "\nOutput:", gate_result)
        ...
        if departureCode != departureCode_result:
            print("update_airport_departures function failed for flight", flightNum, ", destination codes did not match: ")
