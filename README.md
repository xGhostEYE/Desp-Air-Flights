...
```
cd existing_repo
git remote add origin https://git.cs.usask.ca/mel196/comp370fall2022.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.cs.usask.ca/mel196/comp370fall2022/-/settings/integrations)
...
The app should now be available from your browser at the web address: https://localhost:8080
